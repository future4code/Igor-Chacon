...
let comidas = ["ravioli", "macarronada", "pudim", "bolo da moça", "baião de dois"]
console.log(comidas)
...
console.log("Essas são minhas comidas preferidas (com a sua na segunda prosição): ")
console.log(comidas[0])
console.log(comidas[1])
console.log(comidas[2])
console.log(comidas[3])
...
// 4.
p1 = ["você está usando uma camisa azul?", "você está usando uma camisa amarela?", "você está usando uma camisa rosa?"]
r1 = [false, false, false]
console.log(p1[0], r1[0])
console.log(p1[1], r1[1])
console.log(p1[2], r1[2])